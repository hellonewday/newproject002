          ...
          (function () {
            ...
            e.exports = new c(function (c, e) {
              d.listen(function (c, d) {
                ...
                if (g !== null && g.toUpperCase() === "LDU")
                  if (h === "1" && i === "1000") return;
                  else h === "0" && i === "0" && (l = !0);
                d.each(function (a, b) {
                  if (a) {
                    a = a.match(/^cd\[(.+)\]$/);
...
fbq.registerPlugin("856509515176581", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("856509515176581", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("856509515176581", "MicrodataJsonLd", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("856509515176581", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    fbq.loadPlugin("inferredevents");
    instance.optIn("856509515176581", "IWLParameters", true);
    fbq.set("iwlExtractors", "856509515176581", []);
    fbq.loadPlugin("cookie");
    instance.optIn("856509515176581", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    fbq.loadPlugin("identity");
    instance.optIn("856509515176581", "AutomaticSetup", true);
    ...
    config.set("856509515176581", "prohibitedSources", {
      prohibitedSources: [],
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("856509515176581", "ProhibitedSources", true);
    config.set("856509515176581", "unwantedData", {
      blacklisted_keys: {},
      sensitive_keys: {
        TimeOnPage_600_seconds: {
          cd: [],
          url: [
            "45789de228b7f1e19040dae1bfc87b2dfb75c6982d3c02c7ca4d0ad3138dc8e0",
            "169678dce7318198c33b262c2689df85ffb5425f7e9a3faa254be3ce87dfad04",
            "83414055f7fd1fe7b0bccb32d4ee9b5b4380f144ac97baee7492aaf9c8c81745",
            "8e544e403885fd1194f9263047e2597d172cc4e481d7167357bf975e0b62d8dc",
            "704f47a313db26166a87b80abc25005b87e339fc30d12df6b11f51f1e8d043a4",
            "e604433580f3b7d085efb5bc31dae162fe749744696dd9b39db09a467f10e31d",
            "0ccbdae194a1f493154172e49f50b56b1c2c6028c93e110b94ffa4c3f85e3d15",
            "193091fe330c00d077efd6fe985bac3bfefbb9f2605e805fef4c7dea7a0132c3",
          ],
        },
        TimeOnPage_180_seconds: {
          cd: [],
          url: [
            "45789de228b7f1e19040dae1bfc87b2dfb75c6982d3c02c7ca4d0ad3138dc8e0",
            "169678dce7318198c33b262c2689df85ffb5425f7e9a3faa254be3ce87dfad04",
        ...
        ViewContent: {
          cd: [],
          url: [
            "8ab5ace78b1735358cd51727ca0f56704ea3edc1c3051aa5d0cff0efef8918f3",
            "45789de228b7f1e19040dae1bfc87b2dfb75c6982d3c02c7ca4d0ad3138dc8e0",
            "51a7247456301c691ddffbea079a0e1f3a091e8af0202f80f7b9da9b64ea51ce",
            "169678dce7318198c33b262c2689df85ffb5425f7e9a3faa254be3ce87dfad04",
            "83414055f7fd1fe7b0bccb32d4ee9b5b4380f144ac97baee7492aaf9c8c81745",
            "51dfc20d9b8b292e1cb2456336dd3858f3de288d20d5f893df2900f979fce376",
            "8e544e403885fd1194f9263047e2597d172cc4e481d7167357bf975e0b62d8dc",
            "704f47a313db26166a87b80abc25005b87e339fc30d12df6b11f51f1e8d043a4",
          ],
        },
        ScrollDepth_25_percent: {
          cd: [],
          url: [
            "8ab5ace78b1735358cd51727ca0f56704ea3edc1c3051aa5d0cff0efef8918f3",
            "45789de228b7f1e19040dae1bfc87b2dfb75c6982d3c02c7ca4d0ad3138dc8e0",
    ...
    instance.optIn("856509515176581", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("856509515176581", "IABPCMAEBridge", true);
    instance.configLoaded("856509515176581");
  },
});
